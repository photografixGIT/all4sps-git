...
*}
      ...
      <br />
       <span class="price_note">
          <span class="vat_info">{$Artikel->cMwstVersandText}</span><br />
		   <a href="{$oArtikel->cURL}" title="{$oArtikel->cName|strip_tags|escape:"quotes"}" class="detail_article_box_link">Details</a>
