...
{else}
   ...
   <div id="content">
      ...
      {* A ODM, 05.12.2013: had no clue why the startcats ar not shown on the homepage. The only two options to solve the issue: comment out the condition below or check why neither apply...I opted for the first workaround... *}
